<?php //netteCache[01]000235a:2:{s:4:"time";s:21:"0.39067000 1283189030";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:80:"/home/jirka/Omnique/Omnique_shop/document_root/app/templates/Login/default.phtml";i:2;i:1279482857;}}}?><?php
// file …/templates/Login/default.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, '2d389fbb95'); unset($_extends);


//
// block content
//
if (!function_exists($_cb->blocks['content'][] = '_cbba5bf462d00_content')) { function _cbba5bf462d00_content() { extract(func_get_arg(0))
?>
...
<a href="<?php echo TemplateHelpers::escapeHtml($control->link("Registrace:forgotpass")) ?>" id="lostPWD">Zapoměli jste heslo?</a>
