...
class ManagerPresenter extends TemplatePresenter
{
	...
	public function createComponentAddkomp() {
		...
		$form->addText('nakupni_cena','Nákupní cena [Kč]:')
		->addRule(Form::FILLED, 'Zadejte nákupní cenu')
		->addRule(Form::INTEGER, 'cena musí být číslo');
		
		$form->addText('marze','Marže [Kč]:')
		->addRule(Form::FILLED, 'Zadejte marzi')
		->addRule(Form::INTEGER, 'marze musí být číslo');
	...
	public function createComponentEditKomp() {
		...
		if(isset($this->komponenta) && is_object($this->komponenta))
		{
